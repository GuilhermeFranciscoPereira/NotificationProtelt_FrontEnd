...
export default function UpdateFields(): React.ReactNode {
  const {handleSubmit, onSubmit, register, errors, handleFileChange} = useUpdateInfringement();
  ...
  return (
    <form className={style.formContainer} onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
      ...
      <button type="submit" className={style.submitBtn}>Salvar Alterações</button>
    </form>
  );
}
